module lab3_nk(input logic reset,
	...
	logic clk, scanClk, debounceClk, countReset, scan1EN, scan2EN, displayEN, displayCountReset;
    ...
    freqconverter #(.MAX(1200000), .WIDTH(32)) counter(clk, debounceCountReset, 1'b1, debounceClk, debounceCount);	
    ...
    keypadFSM	fsm(clk, reset, syncCols, rows, initialMap, finalMap, checkCol, debounceCount, scan1EN, scan2EN, displayEN, debounceCountReset, stateLEDs);
	...
	muxCounter mc1(clk, reset, 1'b1, 8'b00000000, anodeLeft, anodeRight, switchLeftDontUse, switchRightDontUse);
